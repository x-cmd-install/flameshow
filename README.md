...
[![x-cmd/install — flameshow Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/flameshow.svg)](https://x-cmd.com/install/flameshow)
...
- **Stars**: 1,128 · **Forks**: 22 · **Open issues**: 15 · **Contributors**: 7

## Totals (cumulative)

- **Releases**: 10 · **Merged PRs**: 67 · **Open PRs**: 0 · **Closed issues**: 8 · **Open issues**: 7 · **Commits**: 364
...
_Snapshot: `data/card/260923.yml` · 2026-09-23T05:02:14Z._
